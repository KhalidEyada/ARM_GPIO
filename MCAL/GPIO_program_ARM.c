...
*/
 void DIO_voidSetPinMode(u32 copy_u32PORT ,u32 copy_u32PIN,u32 copy_u32MODE) 
 {
	 RCC_AHB1ENR |= (1u << 0);
	        switch (copy_u32PORT)
	        {
	  	      case GPIOA_PORT: GPIOA_MODER |=(u32)  (copy_u32MODE << (copy_u32PIN)); break;
					  case GPIOB_PORT: GPIOB_MODER |=(u32)  (copy_u32MODE << (copy_u32PIN)); break;
					  case GPIOC_PORT: GPIOC_MODER |=(u32)  (copy_u32MODE << (copy_u32PIN)); break;
					  case GPIOD_PORT: GPIOD_MODER |=(u32)  (copy_u32MODE << (copy_u32PIN)); break;
					  case GPIOE_PORT: GPIOE_MODER |=(u32)  (copy_u32MODE << (copy_u32PIN)); break;
					  ...
					  case GPIOH_PORT: GPIOH_MODER |=(u32)  (copy_u32MODE << (copy_u32PIN)); break;		
					  default: break;		
		     }
